...
from .views import update_cliente, ClienteViewSet, ClienteRegisterView, ClienteLoginView, ClienteLogoutView, ClienteDetailView, ClienteLoggedInView
...
urlpatterns = [
    ...
    path('clientes/update/', update_cliente, name='update_cliente'),
